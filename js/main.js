...
function buildPointsMenuHtml(totalPoints, hidePoints) {
  ...
  const pointsRow = hidePoints
    ? '<span class="points-row"><span class="points-chev"><svg viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg></span></span>'
...
function renderInicioTab() {
  ...
  const pointsMenuHtml = buildPointsMenuHtml(
    AppState.pointsReady ? getUserTotalRealPoints(user.name) : null,
    isPretemporada
  );
